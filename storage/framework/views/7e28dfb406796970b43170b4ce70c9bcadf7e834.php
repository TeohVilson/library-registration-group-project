                        ...
                        <?php if(auth()->guard()->check()): ?>
                            <?php if($book->stock > 0): ?>
                                <div class="book-actions">
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('rent', $book)): ?>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\SONG\Desktop\LibraryRegistrationSystem\resources\views/search.blade.php ENDPATH**/ ?>